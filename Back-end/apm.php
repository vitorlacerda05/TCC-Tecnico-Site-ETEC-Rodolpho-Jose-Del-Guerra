 ...
 */
    ...
    class apmPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Apm');
            $this->SetMenuLabel('Apm');
            ...
            $this->dataset->addFields(
                array(
                    new IntegerField('id_apm', true, true, true),
        ...
        {
            return array(
                new FilterColumn($this->dataset, 'id_apm', 'id_apm', 'Id Apm'),
        ...
        {
            //
            // View column for id_apm field
            //
            $column = new NumberViewColumn('id_apm', 'id_apm', 'Id Apm', $this->dataset);
    ...
    try
    {
        $Page = new apmPage("apm", "apm.php", GetCurrentUserPermissionsForPage("apm"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("apm"));
