 ...
 */
    ...
    class cursos_tecnicosPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Cursos Tecnicos');
            $this->SetMenuLabel('Cursos Tecnicos');
            ...
            $this->dataset->addFields(
                array(
                    new IntegerField('id_curso', true, true, true),
        ...
        {
            return array(
                new FilterColumn($this->dataset, 'id_curso', 'id_curso', 'Id Curso'),
        ...
        {
            //
            // View column for id_curso field
            //
            $column = new NumberViewColumn('id_curso', 'id_curso', 'Id Curso', $this->dataset);
    ...
    try
    {
        $Page = new cursos_tecnicosPage("cursos_tecnicos", "cursos_tecnicos.php", GetCurrentUserPermissionsForPage("cursos_tecnicos"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("cursos_tecnicos"));
