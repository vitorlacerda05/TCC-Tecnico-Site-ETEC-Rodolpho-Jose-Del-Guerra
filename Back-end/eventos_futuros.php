 ...
 */
    ...
    class eventos_futurosPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Eventos Futuros');
            $this->SetMenuLabel('Eventos Futuros');
        ...
        protected function getFiltersColumns()
        {
            return array(
                ...
                new FilterColumn($this->dataset, 'horario', 'horario', 'Horario'),
        ...
        protected function AddFieldColumns(Grid $grid, $withDetails = true)
        {
            ...
            //
            // View column for horario field
            //
            $column = new DateTimeViewColumn('horario', 'horario', 'Horario', $this->dataset);
            $column->SetOrderable(true);
        ...
        protected function AddEditColumns(Grid $grid)
        {
            ...
            //
            // Edit column for horario field
            //
            $editor = new TimeEdit('horario_edit', 'H:i:s');
            $editColumn = new CustomEditColumn('Horario', 'horario', $editor, $this->dataset);
            $validator = new RequiredValidator(StringUtils::Format($this->GetLocalizerCaptions()->GetMessageString('RequiredValidationMessage'), $editColumn->GetCaption()));
            $editor->GetValidatorCollection()->AddValidator($validator);
            $editColumn->setAllowListCellEdit(false);
            $editColumn->setAllowSingleViewCellEdit(false);
    ...
    try
    {
        $Page = new eventos_futurosPage("eventos_futuros", "eventos_futuros.php", GetCurrentUserPermissionsForPage("eventos_futuros"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("eventos_futuros"));
