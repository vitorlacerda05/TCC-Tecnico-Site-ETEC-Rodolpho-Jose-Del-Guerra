 ...
 */
    ...
    class vagas_remanescentesPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->SetTitle('Vagas Remanescentes');
            $this->SetMenuLabel('Vagas Remanescentes');
            ...
            $this->dataset->addFields(
                array(
                    new IntegerField('id_vaga', true, true, true),
        ...
        {
            return array(
                new FilterColumn($this->dataset, 'id_vaga', 'id_vaga', 'Id Vaga'),
        ...
        {
            //
            // View column for id_vaga field
            //
            $column = new NumberViewColumn('id_vaga', 'id_vaga', 'Id Vaga', $this->dataset);
    ...
    try
    {
        $Page = new vagas_remanescentesPage("vagas_remanescentes", "vagas_remanescentes.php", GetCurrentUserPermissionsForPage("vagas_remanescentes"), 'UTF-8');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("vagas_remanescentes"));
