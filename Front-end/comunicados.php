      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Comunicados da direção</h1>
          </div>
        </div>
      </div>
    </section>
	...
	<div class="container">
		<div class="row">
			...
			<?php
						...
						$controle_botao = 0;
						$result_comunicado = "SELECT * FROM comunicados ORDER BY id_comunicado";
						$resultado_comunicado = mysqli_query($conn, $result_comunicado);
						...
						<br>
								<div class="item active">
									<center>
										<table>
											<tr>
												<th class="table-bordered " width="250" height="100"><center><h3><?php echo utf8_encode($row_comunicado['titulo'])?></h3</center></th>
												<th class="table-bordered " width="700" height="100">
													<p align="justify" class="pl-4 pr-4 pt-2"><?php echo utf8_encode($row_comunicado['comunicado'])?></p>
												</th>
											</tr>
										</table>
									</center>
