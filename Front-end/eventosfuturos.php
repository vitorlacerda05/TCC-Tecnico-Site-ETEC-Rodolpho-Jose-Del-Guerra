      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Eventos Futuros</h1>
          </div>
        </div>
      </div>
    </section>
	...
	<div class="container">
		<div class="row">
			...
			<?php
						...
						$controle_botao = 0;
						$result_eventos = "SELECT * FROM eventos_futuros ORDER BY id_evento";
						...
						while ($row_eventos = mysqli_fetch_assoc($resultado_eventos)){ 
							if($controle_botao <> 1){?>
								...
								<div class="item active">
										<table>
											<tr>
												<th class="table-bordered " width="600" height="100"><center><h3><?php echo utf8_encode($row_eventos['nome'])?></h3</center></th>
												<th class="table-bordered " width="600" height="100">
												
													<p>	<strong>Data:</strong><?php echo utf8_encode($row_eventos['data'])?></p>
													<p>	<strong>Horário:</strong><?php echo utf8_encode($row_eventos['horario'])?></p>
													<p>	<strong>Local:</strong><?php echo utf8_encode($row_eventos['local'])?></p>
													<button class="accordion">Objetivo/Informações</button>
														<div class="panel">
														  <p><?php echo utf8_encode($row_eventos['descricao'])?></p>
														</div>
								...
								<div class="item active">
										<table>
											<tr>
												<th class="table-bordered " width="250" height="100"><center><h3><?php echo utf8_encode($row_eventos['nome'])?></h3</center></th>
												<th class="table-bordered " width="250" height="100">
