      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Projetos</h1>
          </div>
        </div>
      </div>
    </section>
	<br>
	  ...
	  <div class="col-md-12">
					<?php
						...
						$controle_botao = 0;
						$result_projetos = "SELECT * FROM projetos ORDER BY id_projeto";
						$resultado_projetos = mysqli_query($conn, $result_projetos);
						while ($row_projeto = mysqli_fetch_assoc($resultado_projetos)){ 
							if($controle_botao <> 1){?>
								<br>
								<div class="item active">
									<button class="accordion"><h5 class="heading"><?php echo utf8_encode($row_projeto['nome_do_projeto'])?></h5></button>
										<div class="panel">
										<br>
													<p><?php echo utf8_encode($row_projeto['descricao'])?></p>
										</div>
									</div>	
								<?php
