      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">APM- Associação de pais e mestres</h1>
          </div>
        </div>
      </div>
    </section>
		...
		<div class="container">
			...
			<div class="col-md-12">
				<?php
						...
						$controle_botao = 0;
						$result_apm = "SELECT * FROM apm ORDER BY id_apm";
						$resultado_apm = mysqli_query($conn, $result_apm);
						while ($row_apm= mysqli_fetch_assoc($resultado_apm)){ 
							if($controle_botao <> 1){?>
						<br>
								<div class="item active">
									<button class="accordion"><h5 class="heading"><?php echo utf8_encode($row_apm['titulo'])?></h5></button>
									 
									 <div class="panel">
													<p><?php echo utf8_encode($row_apm['descricao'])?></p>
										</div>
									</div>	
	...
	<footer class="ftco-footer ftco-bg-dark ftco-section">
      <div class="container">
        <div class="row mb-5">
            ...
            <div class="ftco-footer-widget mb-5">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                ...
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text"> (19)3681-2389</span></a></li>
          ...
          <div class="col-md-6 col-lg-3">
            <div class="ftco-footer-widget mb-5">
              <h2 class="ftco-heading-2">NSA online</h2>
