      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Vagas Remanescentes</h1>
          </div>
        </div>
      </div>
    </section>
		...
		<div class="row">
			<div class="col-md-12">
				<?php
						...
						$controle_botao = 0;
						$result_vaga = "SELECT * FROM vagas_remanescentes ORDER BY id_vaga";
						$resultado_vaga = mysqli_query($conn, $result_vaga);
						while ($row_vaga = mysqli_fetch_assoc($resultado_vaga)){ 
							if($controle_botao <> 1){?>
						<br>
								<div class="item active">
									<button class="accordion"><h5 class="heading"><?php echo utf8_encode($row_vaga['titulo'])?></h5></button>
									 
									 <div class="panel">
													<p><?php echo utf8_encode($row_vaga['descricao'])?></p>
										</div>
									</div>	
