      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Reuniões de Pais e Mestres</h1>
          </div>
        </div>
      </div>
    </section>
	...
	<div class="container">
		<div class="row">
			...
			<?php
						...
						$controle_botao = 0;
						$result_reuniao = "SELECT * FROM reunioes ORDER BY id_reuniao";
						$resultado_reuniao = mysqli_query($conn, $result_reuniao);
						while ($row_reuniao = mysqli_fetch_assoc($resultado_reuniao)){ 
							if($controle_botao <> 1){?>
								...
								<div class="item active">
										<table>
											<tr>
												<th class="table-bordered " width="600" height="100"><center><h3><?php echo utf8_encode($row_reuniao['nome_reuniao'])?></h3</center></th>
												<th class="table-bordered " width="600" height="100">
												
													<p>	<strong>Data:</strong><?php echo utf8_encode($row_reuniao['data'])?></p>
													<p>	<strong>Horário:</strong><?php echo utf8_encode($row_reuniao['hora'])?></p>
													<p>	<strong>Local:</strong><?php echo utf8_encode($row_reuniao['local'])?></p>
													<button class="accordion">Objetivo/Informações</button>
														<div class="panel">
														  <p><?php echo utf8_encode($row_reuniao['descricao'])?></p>
														</div>
