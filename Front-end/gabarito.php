      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Gabarito do Simulado</h1>
          </div>
        </div>
      </div>
    </section>
		...
		<div class="row">
			<div class="col-md-12">
				<?php
						...
						$controle_botao = 0;
						$result_gabarito = "SELECT * FROM gabarito ORDER BY id_gabarito";
						$resultado_gabarito = mysqli_query($conn, $result_gabarito);
						while ($row_gabarito = mysqli_fetch_assoc($resultado_gabarito)){ 
							if($controle_botao <> 1){?>
						<br>
								<div class="item active">
									<button class="accordion"><h5 class="heading"><?php echo utf8_encode($row_gabarito['serie'])?></h5></button>
									 
									 <div class="panel">
													<p><?php echo utf8_encode($row_gabarito['link'])?></p>
										</div>
									</div>	
