...
<html lang="en">
 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
	        ...
	        <ul class="navbar-nav bg-dark">
	        	<li class="dropdown "><a href="#" class="nav-link">A instituição</a>
					<ul class="dropdown-menu bg-dark" style="list-style: none;" >
						<li class="dropdown-item active bg-dark"><a href="sobrenos.html" class="nav-link active">Sobre nós</a></li>
						<li class="dropdown-item active bg-dark"><a href="corpodocente.html" class="nav-link active">Corpo docente e funcionarios</a></li>
						<li class="dropdown-item active bg-dark"><a href="apm.php" class="nav-link active">Prestações de contas - APM</a></li>
						<li class="dropdown-item active bg-dark"><a href="projetos.php" class="nav-link active">Projetos</a></li>
						<li class="dropdown-item active bg-dark"><a href="https://nsa.cps.sp.gov.br/" class="nav-link active">NSA online</a></li>
					</ul>
					</li>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<button class="accordion"><h5>Plano de Curso e de Trabalho Docente</h5></button>
				<div class="panel">
					<form method="post" name="formPC" onsubmit="RedirecionaPC()" class="formulario"><br>
						<h3>Download Planos de Cursos</h3>
						<select name="opcoes">
								<option value="ensinomedio"><a href="http://www.etecriopardo.com.br/home/docs/pc_2019/ens_medio.pdf ">ENSINO MÉDIO</a></option>
								<option value="http://www.etecriopardo.com.br/home/docs/pc_2019/Etim Qui.pdf">ENSINO MÉDIO INTEGRADO QUÍMICA</option>
								<option value="http://www.etecriopardo.com.br/home/docs/pc_2019/Etim Info Net.pdf">ENSINO MÉDIO INTEGRADO INFORMÁTICA PARA INTERNET</option>
								<option value="http://www.etecriopardo.com.br/home/docs/pc_2019/Adm.pdf">TÉCNICO EM ADMINISTRAÇÃO</option>                    
								<option value="http://www.etecriopardo.com.br/home/docs/pc_2019/Info Net.pdf">TÉCNICO EM INFORMÁTICA PARA INTERNET</option>            
								<option value="http://www.etecriopardo.com.br/home/docs/pc_2019/Log.pdf">TÉCNICO EM LOGÍSTICA</option>   
								<option value="http://www.etecriopardo.com.br/home/docs/pc_2019/qui.pdf">TÉCNICO EM QUÍMICA</option>              
								<option value="http://www.etecriopardo.com.br/home/docs/pc_2019/Seg Trab.pdf">TÉCNICO EM SEGURANÇA DO TRABALHO</option>
						</select>
						<input type="submit" value="Baixar">
					</form>	
						
						<form method="post" name="formPTD" onsubmit="RedirecionaPTD()" class="formulario"><br>
						<h3>Downloads Planos de Trabalho Docente</h3>
			<select name="opcoes">				
					<option value="http://www.etecriopardo.com.br/home/docs/ptd_2019/ens_medio.pdf">ENSINO MÉDIO</option>
                    <option value="http://www.etecriopardo.com.br/home/docs/ptd_2019/etim qui.pdf">ENSINO MÉDIO INTEGRADO QUÍMICA</option>
                    <option value="http://www.etecriopardo.com.br/home/docs/ptd_2019/etim info net.pdf">ENSINO MÉDIO INTEGRADO INFORMÁTICA PARA INTERNET</option>
                    <option value="http://www.etecriopardo.com.br/home/docs/ptd_2019/adm.pdf">TÉCNICO EM ADMINISTRAÇÃO</option>                    
                    <option value="http://www.etecriopardo.com.br/home/docs/ptd_2019/info net.pdf">TÉCNICO EM INFORMÁTICA PARA INTERNET</option>            
                    <option value="http://www.etecriopardo.com.br/home/docs/ptd_2019/Log.pdf">TÉCNICO EM LOGÍSTICA</option>   
                    <option value="http://www.etecriopardo.com.br/home/docs/ptd_2019/quim.pdf">TÉCNICO EM QUÍMICA</option>              
                    <option value="http://www.etecriopardo.com.br/home/docs/ptd_2019/seg trab.pdf">TÉCNICO EM SEGURANÇA DO TRABALHO</option>
			</select>
			<input type="submit" value="Baixar">
		</form>
		</div>
		<br>
				<?php
						...
						$controle_botao = 0;
						$result_download = "SELECT * FROM downloads ORDER BY id_download";
						$resultado_download = mysqli_query($conn, $result_download);
						while ($row_download = mysqli_fetch_assoc($resultado_download)){ 
							if($controle_botao <> 1){?>
						<br>
								<div class="item active">
									<button class="accordion"><h5 class="heading"><?php echo utf8_encode($row_download['titulo'])?></h5></button>
									 
									 <div class="panel">
													<p><?php echo utf8_encode($row_download['descricao'])?></p>
													<p><?php echo utf8_encode($row_download['arquivo'])?></p>
										</div>
									</div>	
					...
					?>
					<br>
					<button class="accordion"><h5>Calendário Escolar</h5></button>
				<div class="panel">
					<p>O Calendário Escolar permite visualizar todo o ano letivo planejado, considerando datas especiais como, eventos, reuniões, feriados, etc. </p>
					<h5>Donwload</h5>
					<form method="post" name="form" onsubmit="Redireciona()" class="conteudo_texto_simples">
						<select name="opcoes">
							<option value="http://www.etecriopardo.com.br/home/docs/calendario_escolar/2020 atualizado/CALENDÁRIO ESCOLAR - 2020 SEDE.pdf">São José do Rio Pardo</option>
							<option value="http://www.etecriopardo.com.br/home/docs/calendario_escolar/2020 atualizado/CALENDÁRIO ESCOLAR - 2020 CACONDE.pdf">Caconde</option>
							<option value="http://www.etecriopardo.com.br/home/docs/calendario_escolar/2020 atualizado/CALENDÁRIO ESCOLAR - 2020 SS GRAMA.pdf">São Sebastião da Grama</option>
							<option value="http://www.etecriopardo.com.br/home/docs/calendario_escolar/2020 atualizado/CALENDÁRIO ESCOLAR - 2020 TAPIRATIBA.pdf">Tapiratiba</option>
							<option value="http://www.etecriopardo.com.br/home/docs/calendario_escolar/2020 atualizado/CALENDÁRIO ESCOLAR - 2020 SJ BOA VISTA.pdf">São João da Boa Vista</option>
						</select>
						<input type="submit" value="Baixar">
				</form>
				</div>
