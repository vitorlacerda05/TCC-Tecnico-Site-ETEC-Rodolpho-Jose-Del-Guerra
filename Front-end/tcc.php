      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">TCC - Trabalho de Conclusão de Curso</h1>
          </div>
        </div>
      </div>
    </section>
		...
		<div class="row">
			<div class="col-md-12">
				<?php
						...
						$controle_botao = 0;
						$result_tcc = "SELECT * FROM tcc ORDER BY id_tcc";
						$resultado_tcc = mysqli_query($conn, $result_tcc);
						while ($row_tcc = mysqli_fetch_assoc($resultado_tcc)){ 
							if($controle_botao <> 1){?>
						<br>
								<div class="item active">
									<button class="accordion"><h5 class="heading"><?php echo utf8_encode($row_tcc['nome'])?></h5></button>
									 
									 <div class="panel">
													<p>Tema:<?php echo utf8_encode($row_tcc['descricao'])?></p>
													<p>Nome dos Desenvolvedores: <?php echo utf8_encode($row_tcc['nomes_dos_desenvolvedores'])?></p>
													<p>Arquivo: <?php echo utf8_encode($row_tcc['arquivo'])?></p>
										</div>
									</div>	
