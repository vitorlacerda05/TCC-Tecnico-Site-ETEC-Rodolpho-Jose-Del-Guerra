      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Concursos e Processos seletivos</h1>
          </div>
        </div>
      </div>
		...
		<div class="row">
			<div class="col-md-12">
				<?php
						...
						$controle_botao = 0;
						$result_concurso = "SELECT * FROM concursos ORDER BY id_concurso";
						$resultado_concurso = mysqli_query($conn, $result_concurso);
						while ($row_concurso = mysqli_fetch_assoc($resultado_concurso)){ 
							if($controle_botao <> 1){?>
						<br>
								<div class="item active">
									<button class="accordion"><h5 class="heading"><?php echo utf8_encode($row_concurso['titulo'])?></h5></button>
									 
									 <div class="panel">
													<p><?php echo utf8_encode($row_concurso['links'])?></p>
										</div>
									</div>	
