 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark ftco-navbar-light" id="ftco-navbar">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Cursos Técnicos</h1>
          </div>
        </div>
      </div>
    </section>
	...
	<div class="container">
		...
		<?php
						...
						$controle_botao = 0;
						$result_cursos = "SELECT * FROM cursos_tecnicos ORDER BY id_curso";
						$resultado_cursos = mysqli_query($conn, $result_cursos);
						while ($row_cursos = mysqli_fetch_assoc($resultado_cursos)){ 
							if($controle_botao <> 1){?>
						<br>
								<div class="item active">
									<button class="accordion"><h5 class="heading"><?php echo utf8_encode($row_cursos['titulo'])?></h5></button>
									 
									 <div class="panel">
													<p><?php echo utf8_encode($row_cursos['descricao'])?></p>
										</div>
									</div>	
