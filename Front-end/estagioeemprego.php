      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Vagas de Estágio e Empregos</h1>
          </div>
        </div>
      </div>
    </section>
		...
		<div class="row">
			<div class="col-md-12">
				<?php
						...
						$controle_botao = 0;
						$result_estagio = "SELECT * FROM estagio ORDER BY id_estagio";
						$resultado_estagio = mysqli_query($conn, $result_estagio);
						while ($row_estagio = mysqli_fetch_assoc($resultado_estagio)){ 
							if($controle_botao <> 1){?>
						<br>
								<div class="item active">
									<button class="accordion"><h5 class="heading"><?php echo utf8_encode($row_estagio['nome_vaga'])?></h5></button>
									 
									 <div class="panel">
													<p><?php echo utf8_encode($row_estagio['vagas'])?></p>
										</div>
									</div>	
